...
import com.ezequieldiaz.vacunatorioapp.databinding.ActivityLoginBinding;
...
public class LoginActivity extends AppCompatActivity implements SensorEventListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.btnIngresar.setOnClickListener(view -> vm.logueo(binding.etMatricula.getText().toString(), binding.etClave.getText().toString()));
