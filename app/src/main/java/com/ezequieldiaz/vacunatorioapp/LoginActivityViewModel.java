package com.ezequieldiaz.vacunatorioapp;
...
import com.ezequieldiaz.vacunatorioapp.model.Agente;
import com.ezequieldiaz.vacunatorioapp.request.ApiClient;
...
public class LoginActivityViewModel extends AndroidViewModel {
    ...
    private float shake;
    private static final String SHAKE_ACTION = "com.ezequieldiaz.vacunatorioapp.SHAKE_DETECTED";
    ...
    public void logueo(String matricula, String clave) {
        ApiClient.MisEndPoints api = ApiClient.getEndPoints();
        Call<String> call = api.login(matricula, clave);
        ...
        call.enqueue(new Callback<Agente>() {
            ...
            public void onResponse(Call<Agente> call, Response<Agente> response) {
                if (response.isSuccessful()) {
                    ...
                    editor.putString("matricula", response.body().getEmail());
                    editor.apply();
                } else {
                    Log.d("salida", response.message());
                }
